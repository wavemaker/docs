          ...
          },
          {
            ...
            items: [
              ...
              "user-interfaces/web/components/angular-components/form-widgets/checkbox",
              {
                type: "category",
                label: "CheckboxSet",
                items: ["user-interfaces/web/components/angular-components/form-widgets/checkboxset"],
              },
              ...
              },
              {
                type: "category",
                label: "Rating",
                items: ["user-interfaces/web/components/angular-components/form-widgets/rating-widget"],
              },
