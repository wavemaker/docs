...
With WaveMaker 10.6 release, we have fixed a few bugs. [Know more details here](#).
...
![theme builder dashboard tile2](/img/blogs/theme-builder-dashboard-tile2.png)

3. Enter a website URL. For example, `https://www.google.com/`, and click **Search URL** to generate the color palette of the website.

![theme builder import theme](/img/blogs/theme-builder-import-theme.png)
...
![theme builder color list](/img/blogs/theme-builder-dynamic-color-list.png)
