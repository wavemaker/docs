...
[![Old Zoom options replacing previous MDPI settings](/img/blogs/zoom-level-settings/layout-options.png)](/img/blogs/zoom-level-settings/layout-options.png)
...
[![New Zoom options replacing previous MDPI settings](/img/blogs/zoom-level-settings/zoom-options.png)](/img/blogs/zoom-level-settings/zoom-options.png)
...
[![Example of a zoomed-out view (85%) using the new Zoom Level settings](/img/blogs/zoom-level-settings/zoom-on-canvas.png)](/img/blogs/zoom-level-settings/zoom-on-canvas.png)
