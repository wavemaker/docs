...
![WaveMaker Docs Homepage](/img/blogs/wavemaker-docs-homepage.png)
...
![recently visited page](/img/blogs/recently-visited-document.png)
...
![search recommendations](/img/blogs/search-recommendations.png)
...
![documentation-full-page-reading](/img/blogs/documentation-full-page-reading.png)

> *Bonus: the right-nav is collapsed by default, so it’s clean and distraction-free from the get-go.*

![rightnav-collapsed-1.png](/img/blogs/rightnav-collapsed.png)
...
![WaveMaker academy](/img/blogs/go-to-academy.png)
