...
[![DnD Chart widget](/img/blogs/wm-blog-covid19-18-charts-visualization.png)](/img/blogs/wm-blog-covid19-18-charts-visualization.png)

[![Bind values](/img/blogs/wm-blog-covid19-19-bind-chart-values.png)](/img/blogs/wm-blog-covid19-19-bind-chart-values.png)  
...
In this particular case for the [bar chart](/docs/user-interfaces/web/components/angular-components/chart/chart-widget#4-bar-chart), we have picked *country* on x-axis and *confirmedCases* attribute from API, to be depicted for each country on y-axis.
...
[![Configuring titles](/img/blogs/wm-blog-covid19-20-configuring-titles.png)](/img/blogs/wm-blog-covid19-20-configuring-titles.png)

[![Top affected countries](/img/blogs/wm-blog-covid19-21-top-affected-countries.png)](/img/blogs/wm-blog-covid19-21-top-affected-countries.png)
...
[![low code](/img/blogs/wm-blog-covid19-22-low-code-js.png)](/img/blogs/wm-blog-covid19-22-low-code-js.png)
...
:::tip
Download the **[D3Maps.zip](https://github.com/wavemaker/prefab-datamaps)**, and import it the **Prefabs** section to use it straightaway. For more information about how to use it, see [Importing Prefab](#).
:::
...
[![Prefab config](/img/blogs/wm-blog-covid19-11-prefab-config.png)](/img/blogs/wm-blog-covid19-11-prefab-config.png)
...
[![Prefab config](/img/blogs/wm-blog-covid19-12-testing-prefab.png)](/img/blogs/wm-blog-covid19-12-testing-prefab.png)

[![Prefab config](/img/blogs/wm-blog-covid19-13-prefab-values.png)](/img/blogs/wm-blog-covid19-13-prefab-values.png)
...
[![Prefab config](/img/blogs/wm-blog-covid19-14-prefab-publish.png)](/img/blogs/wm-blog-covid19-14-prefab-publish.png)
...
[![maps prefab](/img/blogs/wm-blog-covid19-15-using-maps-prefab.png)](/img/blogs/wm-blog-covid19-15-using-maps-prefab.png)

### Defining Color Map and Dataset

Color map needed for the maps prefab can be created as a variable, shown below.

[![maps prefab](/img/blogs/wm-blog-covid19-16-color-map-dataset.png)](/img/blogs/wm-blog-covid19-16-color-map-dataset.png)
...
[![maps prefab](/img/blogs/wm-blog-covid19-17-custom-maps-dataset.png)](/img/blogs/wm-blog-covid19-17-custom-maps-dataset.png)
