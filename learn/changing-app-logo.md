...
1. From the Main Menu, under **Import -> Resource** option locate the _logo _under the images folder. [![design_logo_resource](./assets/design_logo_resource.png)](./assets/design_logo_resource.png)
