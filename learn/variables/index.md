...
Service can be accessed from within your app using Variables. These variables allow one to trigger the methods within the Java Service, pass the necessary parameters to the method and access the results from the method.

[![](../assets/Var_create.png)](../assets/Var_create.png)[![](../assets/JS_var_create.png)](../assets/JS_var_create.png)

each method within the Java Service, a service variable can be generated using the appropriate option from the property; with the **parameters** available within the **tab** and the available as the **for binding** You can invoke the Java Service by triggering a call to the Service Variable generated. In case you have multiple public class methods in your Java Service, you will see multiple Operation options.

[more about Variables from here](/learn/app-development/variables/data-integration/) [how to Create Variables from here](http://m/learn/app-development/variables/java-services/)
...
- [5.4 Java Services](/learn/app-development/services/java-services/java-service/)
    ...
    - [Integration Services](/learn/app-development/services/java-services/java-integration-services/)
