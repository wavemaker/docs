...
2. of live form can be set to or _,_ i.e. it can be displayed on the page or can be displayed as a pop-up dialog.
3. of the Live Form can be set to be   _only._
4. from this, the **of the caption** for the form fields can be configured to be placed at the , or of the form fields.
