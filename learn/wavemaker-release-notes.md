...
|---|---|---|
|[WaveMaker 11.11.6](/learn/wavemaker-release-notes/v11-11-6) <p style={{color:"red"}}>*latest*</p> | WaveMaker's Release 11.11.6 introduces global error handling in mobile apps to prevent crashes, new React Native enhancements, and delivers several bug fixes across web and mobile app. | 14 July 2025 |
