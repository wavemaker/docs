...
|---|---|---|
|[WaveMaker 11.7.0](/learn/wavemaker-release-notes/v11-7-0) <p style={{color:"red"}}>*latest*</p> | WaveMaker 11.7.0 is here with New Studio with enhanced user experience and performance. This release has new features like API reimport and impact analysis along with many enhancements and bug fixes. In React, we have introduced many new features like CSS variables for styling, Dynamic forms, and Accessibility. Custom Template for widgets along with enhancements and bug fixes. |29 April 2024 |
