...
|---|---|---|
|[WaveMaker 11.8.5](/learn/wavemaker-release-notes/v11-8-5) <p style={{color:"green"}}>*upcoming*</p> |  WaveMaker 11.8.5 includes enhancements and bug fixes. The Skeleton Loader now supports Lottie animations, and you can control child component visibility. The Dialog widget has a new look. Bug fixes include Git navigation, Datatable events, Theme Updates, and checkbox selection issues. React Native fixes address Wizard widget steps and file upload restrictions. |07 October 2024. |
