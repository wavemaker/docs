...
|---|---|---|
|[WaveMaker 11.10.4](/learn/wavemaker-release-notes/v11-10-4) <p style={{color:"red"}}>*latest*</p> | ​WaveMaker's Release 11.10.4 is packed with numerous bug fixes for both Web and React Native platforms. This update also features important enhancements, including titles for web routes, customizing the base path while importing REST services in Web, and introducing an aspect ratio property for images in React Native. | 17 March 2025 |
