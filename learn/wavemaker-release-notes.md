...
|---|---|---|
|[WaveMaker 11.7.4](/learn/wavemaker-release-notes/v11-7-4) <p style={{color:"red"}}>*latest*</p> | In WaveMaker 11.7.4 we have extended support for application deployment with Java 17 and 21. Included improvements like the Themes section in Project Configuration, iframe widget message, and some bug fixes. |17 June 2024 |
