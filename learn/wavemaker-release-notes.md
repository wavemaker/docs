...
|---|---|---|
|[WaveMaker 11.3.4](/learn/wavemaker-release-notes/v11-3-4) <p style={{color:"red"}}>*latest*</p> | WaveMaker has released a version, 11.3.4, containing bug fixes related to user access to a project and loading the project listing page. | 12 June 2023 |
