...
|---|---|---|
|[WaveMaker 11.11.3](/learn/wavemaker-release-notes/v11-11-3) <p style={{color:"red"}}>*latest*</p> | WaveMaker's Release 11.11.3 will include improvements to Progress Bar widget styling options, and several bug fixes across Web and React Native project, Studio UI to enhance stability and usability. | 9 June 2025 |
