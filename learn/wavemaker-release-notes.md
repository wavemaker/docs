...
|---|---|---|
|[WaveMaker 11.11.3](/learn/wavemaker-release-notes/v11-11-3) <p style={{color:"green"}}>*upcoming*</p> | WaveMaker's Release 11.11.3 will introduce the powerful new **Edge-to-Edge App** experience for React Native, bringing support for full-screen layouts, and peek-a-bar behavior, to create more immersive apps. It will also include improvements to widget styling options, and several bug fixes across Web and React Native project, Studio UI to enhance stability and usability. | 9 June 2025 |
|[WaveMaker 11.11.2](/learn/wavemaker-release-notes/v11-11-2) <p style={{color:"red"}}>*latest*</p> | WaveMaker's Release 11.11.2 includes enhancements to the Slider widget in React Native and the option to set the date pattern through a value expression for the web, along with major bug fixes in both Web and React Native. | 26 May 2025 |
