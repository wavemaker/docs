...
|---|---|---|
|[WaveMaker 11.7.1](/learn/wavemaker-release-notes/v11-7-1) <p style={{color:"red"}}>*latest*</p> | WaveMaker 11.7.1 is here with some new enhancements like Internationalization (i18n) message customization, extended Semantic Versioning, disabling Prefab editing in a project, and other bug fixes.. |27 May 2024 |
