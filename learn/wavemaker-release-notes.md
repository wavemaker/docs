...
|---|---|---|
|[WaveMaker 11.8.2](/learn/wavemaker-release-notes/v11-8-2) <p style={{color:"red"}}>*latest*</p> |  WaveMaker release 11.8.2 is a bug fix release which includes the issues with FileUpload widget, Textarea widget, and Page Params. This release also has new CSS classes for Chart widget and a few React Native fixes related to the Show property, Currency widget, Ripple effect, and Wizard widget. |12 August 2024 |
