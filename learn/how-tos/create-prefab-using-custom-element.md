...
Most of the modern javascript frameworks have support for packaging the components as Web Components. WaveMaker supports the use of Web Components inside its projects & recommends its integration through [**Prefabs**](https://www.wavemaker.com/learn/app-development/custom-widgets/custom-widgets). Its recommended to refer [documentation](/learn/app-development/custom-widgets/creating-prefabs/#build-your-own-prefabs) to know more about Prefabs in detail. 
