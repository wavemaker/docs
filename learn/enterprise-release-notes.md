...
|---|---|---|---|
|**v11.2.2** <p style="color:red;">*latest*</p> | - [v11.2.2](/learn/wavemaker-release-notes/v11-2-2) <br> - [v11.2.1](/learn/wavemaker-release-notes/v11-2-1) | This release includes support to Mock APIs using MockingBird platform, formatting fixes, Calendar widget accessibility and icon rendering fixes, and user account log out related issues. | 19 January 2023 |
