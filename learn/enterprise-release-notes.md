...
|---|---|---|---|
|**v11.11.2** <p style={{color:"red"}}>*latest*</p> |- [11.11.2](/learn/wavemaker-release-notes/v11-11-2)| This release includes enhancements to the Slider widget in React Native and the option to set the date pattern through a value expression for the web, along with major bug fixes in both Web and React Native. | 26 May 2025 |
