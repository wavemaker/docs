...
The caption is the text that the end user sees on the Menu label.

Name

The name is a unique identifier for Menu.

**Accessibility**

Hint

Any text or HTML you enter for this property will be shown as a tooltip if the mouse hovers over this widget for 1.5 seconds. It can be bound to a variable.
...
_Vertical_ layout arranges the menu items vertically. _Horizontal_ layout arranges the menu items horizontally.

Menu Position

Position of the menu list items - inline, down-right, down-left, up-left, up-right.
...
Set this property to order the Menu items.
...
This defines the app behavior on click of the Item Link. The options are:
...
Animation on to content

This property controls the animation of the menu items. It can be set to _slide, fade, or scale_. Note: This feature works only in the run mode.
...
This property specifies how the elements should be aligned horizontally. It can be Left, Centered or Right
