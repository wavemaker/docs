...
​WaveMaker's Release 11.10.5 will be here with an important enhancement, exporting Angular zip file. This release also includes many significant bug fixes in both Web and React Native.
...
With this release, we've introduced a new option to export project resources as **Project as Angular ZIP**. The generated ZIP file contains the UI resources of an Angular application, enabling users to utilize these resources outside the studio.
