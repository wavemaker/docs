...
- FileUpload widget: **Clear** and **Delete** methods are introduced to clear and trash uploaded files. 
- We introduced a new property to show characters limits for the Text widget. 
...
- Fixed an issue related to the Text property in WaveMaker Studio, console error: `TypeError: Cannot set properties of undefined (setting 'show')`.
...
- Fixed an issue related to expended rows inside Datatable collapsing when using an on-demand scroll.
