...
| --- | --- | --- |
| JS Binding | jquery <td bgcolor="#44aaf4">  3.3.1 -> 3.4.1 |
|  | jquery-ui* | 1.12.1 |
| MVC Framework | angular <td bgcolor="#44aaf4">  9.1.12 -> 10.2.5 |
|  | angular-ui-bootstrap | 3.3.6 |
|  | ngx-bootstrap | 6.2 |
| Styles | bootstrap | 3.3.7 |
| Charting | d3 | 3.5.17 |
|  | nvd3 | 1.8.6 |
| Built-in functions | lodash <td bgcolor="#44aaf4">  4.17.11 -> 4.17.19|
