...
[React Native](/learn/react-native/react-native) provides new and improved canvas experience, along with the following enchancements.
...
- Fixed an issue related to publishing a Prefab to Teams failing WaveMaker 11.x Prefab holding 10.x Prefabs.
