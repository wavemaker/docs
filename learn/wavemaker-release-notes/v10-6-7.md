...
- Introduced a new property called **Show Display Format On** for the Text widget. This property is useful when you apply **Display Format** on the Text widget. It decides when to use the configured display format.
