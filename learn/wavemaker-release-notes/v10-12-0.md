---
title: "WaveMaker 10.12.0 - Release date: 1 February 2022"
id: ""
...
## Ending Support of 9.x Projects

- Ending support of 9.x Projects. The existing 9.x projects will move to the Archived apps with limited access. Allowed actions include; downloading the project as zip or deleting the project. 

## Bug Fixes

- Fixed an issue related to Data Table's export to Excel functionality when the table is bound to query variable. 
- Fixed an issue related to horizontal scroll of Data Table even when there are enough columns to fit into the table.
