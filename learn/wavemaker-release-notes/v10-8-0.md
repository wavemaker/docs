...
- Support for Artifacts in the Team, including publishing, approval, consumption of Prefabs with an updated flow.
...
- When external changes are made to the DB schema, the respective changes get reimported, regenerating the code to keep the code and schema in sync.

### Library Update

- Update Maven plugin versions to the latest ones in project pom.xml.
