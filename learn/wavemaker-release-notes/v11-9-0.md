...
![Zoom Setings Canvas Before](/learn/assets/zoom-setting-canvas-before.png)

Preview:

![Zoom Setings Preview Before](/learn/assets/zoom-setting-preview-before.png)
...
![Zoom Setings Canvas After](/learn/assets/zoom-setting-canvas-after.png)

Preview:

![Zoom Setings Preview After](/learn/assets/zoom-setting-preview-after.png)
...
In a Data Table, when Multiselect property is enabled in Advanced Settings dialog, the rows cannot be selected. Added a new property in the Advanced Settings dialog, **Row Selectable**, to select the rows once enabled.
