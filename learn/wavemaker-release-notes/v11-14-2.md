---
title: "WaveMaker 11.14.2 - Release date: 1 December 2025"
id: "v11-14-2"
sidebar_label: "v11.14.2"
---
...
<details>
<summary>Fixed Menu Cutoff Issue Near Screen Edges</summary>
...
<details>
<summary>Fixed 1px Cutoff in Progress Circle Widget</summary>
...
<details>
<summary>Resolved Input Issues for Text and Textarea Widgets on iOS</summary>
...
|----|---|---|---|---|
|Form Controls|form.mapping.field.padding||space.2.value|None| Done|
|Form Controls|form.caption.display|-|inline-block|If a developer has already defined this property in app.css, that style will continue to take precedence. Additionally, the token includes the same base value by default, so no changes or actions are required from the developer.
