...
React Native Apps SDK Upgraded to **Expo 54**, **React Native 0.81**
</summary>
...
:::note
With this upgrade, the `elevate` and `boxShadow` style properties are no longer supported. Use `box-shadow` to achieve the same styling effects.
:::
...
|Maven| <td className="versiontdbgcolor"> 3.9.9 -> 3.9.11 </td> |
|npm | 10.9.0 |
| Android Studio | <td className="versiontdbgcolor"> Ladybug 2024.2.2 - Meerkat 2024.3.1 -> Meerkat 2024.3.1 - Narwhal 4 Feature Drop 2025.1.4 </td> |
| Xcode | <td className="versiontdbgcolor"> 15.4  - 16.2 -> 16.2 - 26 </td>|
