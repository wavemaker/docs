...
React Native 0.80+ has a known [issue](https://github.com/facebook/react-native/issues/54217) where adding or removing the `borderWidth` property of a parent component during layout changes causes inner text to disappear.

**Workaround:**

We've introduced a temporary solution. Add the following flag to your `wm_rn_config.json`

```json
"applyBorderWidthStyles": true
```
If you encounter this issue, please use this workaround until React Native releases an official fix in future versions.
