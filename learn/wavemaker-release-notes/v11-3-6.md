...
:::note
Widgets that currently support tap events are, Popover, Switch, Select, Card, Tile, Tabs, Container, Search, Progress circle, Progress bar, Picture, Label, Icon, Button, Anchor, and Carousal.
:::
...
Now you can view the content in multiple Accordion panes at the same time while using the Accordion widget in WaveMaker.
