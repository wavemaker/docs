...
WaveMaker now offers multiple theme support in an application where you can now add and apply additional themes other than the default theme and switch between them. Learn more about [Multi-theme Support](https://docs.wavemaker.com/learn/react-native/theme/#multi-theme-support)
...
Widgets that currently support Long Tap events are, [Tile](https://docs.wavemaker.com/learn/app-development/widgets/container/tile/), [Container](https://docs.wavemaker.com/learn/app-development/widgets/container/), [Progress circle](https://docs.wavemaker.com/learn/app-development/widgets/basic/progress-circle/), [Progress bar](https://docs.wavemaker.com/learn/app-development/widgets/basic/progress-bar), [Picture](https://docs.wavemaker.com/learn/app-development/widgets/basic/picture/), [Label](https://docs.wavemaker.com/learn/app-development/widgets/basic/label), [Button](https://docs.wavemaker.com/learn/app-development/widgets/form-widgets/button/), and [Anchor](https://docs.wavemaker.com/learn/app-development/widgets/basic/anchor).
:::
...
Now you can view the content in multiple Accordion panes at the same time while using the Accordion widget in WaveMaker. Learn more about [Accordion](https://docs.wavemaker.com/learn/app-development/widgets/container/accordion/)

### Multiple Selection in List

You can now select multiple items in a List by enabling the **Multiple Selection** property. `Selection Limit` and `Selection Limit Exceeded` events allow restricting the maximum number of list items that can be selected. Learn more about [Multiple Selection in List](https://docs.wavemaker.com/learn/app-development/widgets/datalive/list/behavior-settings/#multiselect)

### Audio Widget

Introducing the Audio widget in WaveMaker Studio allowing users to add audio files in an application. Learn more about [Audio Widget](https://docs.wavemaker.com/learn/app-development/widgets/basic/audio/)
...
This support is provided as a beta version upgrade. WaveMaker will be introducing this feature in the upcoming release.

:::

## Enhancements

- Users can now have empty placeholders in the Number and Currency widget.
...
- Fixed navigation on the list in a tab issue by providing go to tab and go to Accordion are supported in actions.
- Fixed the date widget inconsistency in web and cordova interface.
