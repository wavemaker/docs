...
- Fixed an issue where the studio did not reload automatically once a variable was renamed.

:::note
:::

- Fixed an issue in Team Portal, where the details of the newly published artifact version was not displayed in Marketplace and Export screen.
...
:::note
This issue occurs when a Theme developed in one preoject is published and imported by team members to use in their projects.
