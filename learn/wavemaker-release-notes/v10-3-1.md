...
- When using Centrail Authentication Server (CAS) as an Authentication provider for an app, you can now configure additional information to be pulled out of CAS for the logged-in user. You can do this by creating a service variable using the `securityService/getSecurityInfo` API
