...
This feature is still in beta and is not enabled by default. Learn more about how to [enable this behavior in your app](/learn/how-tos/true-single-page-app-behavior).
...
- Fixed an issue related to console errors Calender widget in a page when changing language to options other than English.
