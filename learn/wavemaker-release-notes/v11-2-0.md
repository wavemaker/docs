...
With TrueSPA, WaveMaker app's UI behaves closer to a Single Page App functionality. When you navigate between pages, it only affects the content area, rendering of static areas, such as the header, leftnav, footer, etc., remains unaffected, which results in smoother page transitions and a better user experience. 

This feature is still in beta and is not enabled by default. Learn more about how to [enable this behaviour in your app](/learn/how-tos/true-single-page-app-behavior).
