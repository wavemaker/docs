...
- Custom Colors property in the advanced settings of Wm-chart widget is not considering the given array of elements. It is taking the first value as string. This is now fixed.
...
- Apple stops accepting submissions of apps that use UIWebView APIs. This is now fixed. For more information, see [blog on WKWebView](/learn/blog/2020/04/20/wavemaker-wkwebview-upgrade).
