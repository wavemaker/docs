...
- Added support to include or exclude specific URLs for proxying rest services calls.
- Included ‘generated-rn-app', 'generated-angular-app’ folders while exporting the project as zip.
