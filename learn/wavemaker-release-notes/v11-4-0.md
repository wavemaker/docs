...
:::important
As a part of the migration, the user needs to refactor some of the properties. To know more, see [App Security Migration from XML to Java Configuration](website/blog/2023-09-05-xml-to-java-configuration-migration).
:::
