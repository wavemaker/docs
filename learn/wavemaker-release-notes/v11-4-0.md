...
- Added language-specific behaviour like font that can be specified inside language-specific app classes. For example, use the css class `.app-{localecode}` to mention different font families.
