...
A **Core Project** in WaveMaker is a template that contains the common functionality of an application. Multiple team members can work on it before deploying it. Similarly, you can create child projects called **Implementation Project** based on the **Core Project** to add more features or customizations.
