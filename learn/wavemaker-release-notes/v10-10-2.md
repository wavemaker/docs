...
- Updated the Spring and Log4j2 dependencies in the platform code base for the reported vulnerabilities.
- Fixed an issue related to logging in to a WaveMaker app. When you open the app URL in the in-app browser, the login page displays even when you have logged in already.
- Fixed an issue related to subscription upgrade failing in WMO.
