...
WaveMaker has introduced two new options in Manage Projects page, Import Project from Code Repository and Export Project details, while refractoring in Teams Portal. For more information, see [Manage Projects](learn/teams/manage-projects).
