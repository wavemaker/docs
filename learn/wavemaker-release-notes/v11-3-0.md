...
- Introduced a new section called **Access Type** in **Add Code Repository** to administer VCS access to the team members, permitting the members to perform defined VCS operations. For more information, see [Access Type in Code Repository](/learn/teams/code-repository#access-type).

- You can now manage logout sessions of the platform users. For more information, see [Restrict Logout Sessions](/learn/on-premise/configure/config-users-auth-providers#restricting-login-for-all-users).
