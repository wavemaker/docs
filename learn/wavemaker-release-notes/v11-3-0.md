...
### Delight Users with Animations in React Native App

We bring you some facets of design elements to vivify your mobile application. Incorporate app loading animations, skeleton loaders, and more to render at the time of loading the application. This enables developers to achieve consumer-grade applications and provide more delightful experience for the end users. 

#### Splash Screen Animation

Add animation at the time of launching the application loading screen that enchance the app user experience. You can simply add plain color or an image too.

#### Lottie File Support for Spinners

Add Spinners for page that are supported by Lottie files. The Spinner's styling is generated from the default theme or the applied theme.

#### Skeleton Loaders

Enable Skeleton layout loaders. This produces widget's size and styles used in the app to create skeleton of the layout when the application is loading. You can further customize the colors through code.
...
- You can now manage logout sessions of the platform users for performing planned ugrades. For more information, see [Restrict Logout Sessions](/learn/on-premise/configure/config-users-auth-providers#restricting-login-for-all-users).
