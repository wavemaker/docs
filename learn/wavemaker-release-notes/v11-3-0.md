...
Enable Skeleton layout loaders. This produces the widget's size and styles used in the app to create a skeleton of the layout when the application is loading. You can further customize the colors through code. Learn more about [Skeleton Loaders in Mobile apps](/learn/react-native/app-loader#skeleton-loader).
