...
|  | ngx-bootstrap <td bgcolor="#44aaf4"> 5.4 -> 6.2 </td>|
...
| --- | --- | --- |
|  | Spring Framework <td bgcolor="#44aaf4"> 5.2.9 -> 5.3.5</td>|
| Security framework | Spring Security <td bgcolor="#44aaf4"> 5.4.1 -> 5.4.5</td>|
