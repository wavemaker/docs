...
- Supports creating branches for WMO Teams.
- Work on branches to create a feature or fix bugs to keep away from the main codebase until completion.
- Handle all the risks involved in a merge, i.e., deferred until the branch is ready.
- Manually merge pull requests from the source controller.
