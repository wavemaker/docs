...
This release contains bug fixes for the Calendar widget and icon rendering.

## Bug fixes

1. Fixed Calendar issues, including data patterns and alignment of events.
2. Fixed issues related to [Americans with Disabilities Act (ADA)](/learn/app-development/ui-design/accessibility) on Datatable, Carousel, Datepicker, and List widgets.
3. Fixed icons-related issue rendering default icon in Preview mode.
