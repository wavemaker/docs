...
- Fixed issues related to List widget; when binding a list widget to other widget's selected-item node or live filter widget's result node, then templates would not work and led to console errors. This is fixed.
