...
- For mobile apps, when switching the screen size, the variable calls were getting failed. Furthermore, when modifying a variable, it was freezing the studio screen. This is now fixed.

- Chart widget was not loading when used it inside a container widget, including for GridLayout, and Panel. This is fixed.
...
- Auto-complete for Live widgets was not showing results when related entity field is set to autocomplete with custom display expression. This is now fixed.
