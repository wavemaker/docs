...
- Fixed an issue related to styles from the WaveMaker micro app applied to other micro apps within the singe spa application. For more information, see [Micro Frontend Support](/learn/app-development/sspa/micro-frontend).
