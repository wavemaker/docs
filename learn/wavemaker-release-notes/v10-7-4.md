...
- Support for generating Android App Bundle (AAB) file in AppChef and wm-cordova-cli. AAB is new and alternative to the Android Application Package (apk). Google has introduced this format to reduce the size of the installer. For more information, read our blog on [Generating .aab files using wm-cordova-cli or AppChef](/learn/blog/2021/07/19/aab-support).

## Improvements

---

- Added support to view contents of docker file inside WaveMaker Studio.
