...
id: "v11-2-5"
sidebar_label: "v11.2.5 - latest"
---
This release includes bug fixes for accessiblity in widgets and In-memory sessions.

---

## Bug fixes

- Fixed accessibility issues in data table, list, form, switch, tab, radio button, pop-over, carousel, calendar, date, checkbox, label and Nav bar widgets.
- Added setAuthorities method in WMAuthentication class to update or set the authorities.
- Fixed sessions not being removed from application memory when In-Memory session persistence is enabled.
