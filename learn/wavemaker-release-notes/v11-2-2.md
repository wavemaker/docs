...
- Fixed the issue of converting number to string value using NumberToString formatter. 
- In this fix User is getting logged out of application once the application is closed in the recent tabs.
- Data Table default search option is fixed in the prefabs for the web applications.
- Default value is now formatted according to the spanish language.
