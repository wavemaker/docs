...
- **Mobile**: Fixed the issue of logging out of the application once the application is closed in the recent tabs.
...
- Fixed the issue of formatting number value to Spanish appropriately.
- Fixed the Data Table's default search of dynamic data in Prefabs.
