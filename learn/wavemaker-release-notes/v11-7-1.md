...
Applicable for WaveMaker Enterprise (WME) users only.

:::

## Enhancements

### Commit Message Alteration

We have extended our support to alter the commit message during the Core Project Upgrade and Branch merge. In this, the user can add or edit the desired commit message in the same dialog and merge.
...
Added a new dialog for editing i18n Prefab system messages within the project, eliminating the need to manually edit the messages in the en.json or af.json files from File Explorer.
