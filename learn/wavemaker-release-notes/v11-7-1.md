...
We have extended our support to alter the commit message during the Core Project Upgrade and Branch merge. In this, the user can add or edit the desired commit message in the same dialog where he can finish the merge.
