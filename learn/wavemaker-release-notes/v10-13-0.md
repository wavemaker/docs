...
Richtext data is now rendered as plain text in Data Table widget. This is done to prevent XSS attacks in the generate app.

If you still want to render Richtext as HTML in Data Table, change the column widget's view mode to Lable widget. 
