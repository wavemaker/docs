...
Create a WaveMaker Project using the VCS providers' clone URL, allowing you to duplicate the project. 

**Supported providers**: GitHub and GitLab.

### New Format Types in Use Expression

Render HTML contents by setting a flag **trustAs** or **Sanitize** to examine and preserve only designated safe tags.
