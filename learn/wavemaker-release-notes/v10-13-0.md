...
- Create a WaveMaker Project from VCS repository URL. 

### New Format Types in Use Expression

Using Formatters, configure rendering of HTML contents by setting the **Format Type** property, including **trustAs** and **Sanitize** options.
