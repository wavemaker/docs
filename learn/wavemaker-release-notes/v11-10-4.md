...
WaveMaker's Release 11.10.4 is packed with numerous bug fixes for both Web and React Native platforms. This update also features an important enhancement, custom titles for web routes.
