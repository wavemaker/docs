...
![Skip To Main Content Config](/learn/assets/release-notes/skipToMain-11-11-5.png)
</details>
...
Enhanced the **Time** and **DateTime** widgets with a new property: `Show AM/PM Buttons`.

When enabled, this shows **two distinct buttons** for AM and PM, replacing the previous single-toggle button. Selecting one automatically deselects the other, improving clarity and usability.
...
A new **Sort By** field has been added to the widget’s advanced settings. When configured, clicking on a custom column will sort the data based on the specified value.
</details>
