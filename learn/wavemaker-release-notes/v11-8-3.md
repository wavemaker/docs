...
WaveMaker 11.8.3 will be released on September 9th, featuring enhancements to reduce application loading time and the `gotoStep` function in the Wizard widget, along with several bug fixes. This release also introduces a new CSS class in the Accordion widget, accessibility labels for widgets, and various React Native bug fixes.
...
| Title|
| ------- |
| [gotoStep Function in Wizard Widget](#gotostep-function-in-wizard-widget) |
| [Faster Loading of Applications](#faster-loading-of-applications) |
...
| Title|
| ------- |
| [Accessibility Labels in Widgets](#accessibility-labels-in-widgets) |
| [New CSS Class in Accordion Widget](#new-css-class-in-accordion-widget) |
...
| Title|
| ------- |
| [Validation Failure in Number Widget](#validation-failure-in-number-widget) |
| [Backdrop Effect and Arrow Navigation in Dialog Widget](#backdrop-effect-and-arrow-navigation-in-dialog-widget) |
| [Uploading Multiple Files using FileUpload Widget](#uploading-multiple-files-using-fileupload-widget) |
| [Preview Failure while using JWS Secondary Security Provider](#preview-failure-while-using-jws-secondary-security-provider) |
| [Code Intellisense Fixes](#code-intellisense-fixes) |
| [Adding Datatable and Form Widget as Markup Code](#adding-datatable-and-form-widget-as-markup-code) |
| [Display Issue of Drop Down Item in Select Widget](#display-issue-of-drop-down-item-in-select-widget) |
| [Hidden Icon Classes and Icon Preview Issue](#hidden-icon-classes-and-icon-preview-issue) |
| [Display Error in X Axis using Stacked Chart](#display-error-in-x-axis-using-stacked-chart) |
...
| Title|
| ------- |
| [Unable to Add Conditional Class in Forms](#unable-to-add-conditional-class-in-forms) |
| [Main Page Issue in Application](#main-page-issue-in-application) |
| [Widget Value Accessibility in Page and Prefab](#widget-value-accessibility-in-page-and-prefab) |
| [Chart Tooltip Customization using Partial](#chart-tooltip-customization-using-partial) |
| [Tooltip in Arc Chart](#tooltip-in-arc-chart) |  
...
Upon assigning any value to the Page and Prefab level widgets inside a function in the Script tab, user was unable to access the same widget value in the next statement within the same fucntion.
