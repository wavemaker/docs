...
<tr><td><strong>Software</strong></td><td><ul><li>docker 18.06.2-ce</li><li>Python 3.5 or higher</li><li>wget</li><li>container-selinux-2.9-4.el7.noarch.rpm</li></ul></td></tr><tr><td><strong>Network</strong></td><td><ul><li>Static IP</li><li>Full trafic(tcp,udp) should be opened between two all instances</li></td></tr></tbody></table>
