...
We can apply Skeleton Loader to Page, Prefab, and Partial.
...
:::note
Redirect to lottie animation as you can use only Lottie Animation to apply Skeleton Loader to Prefabs.
:::
