...
- For creating a Docker container, use the below Docker command.
    ...
    ```bash
    docker container run -it --name wm-rn-web-preview -p 19009:19009 wavemakerapp/wm-rn-web-preview:<tag> /bin/bash
    ```
...
- This will launch a terminal session in docker container, here we can use [`wm-reactnative-cli`](https://github.com/wavemaker/wm-reactnative-cli) commands.
    ...
    `preview_url` is the react native app preview url (eg:<bold>https://www.wavemakeronline.com/run-ngnfytn5tb/test_master</bold>)

- As it will be suggested, open the given url in the browser where your WaveMaker studio is opened.
- Copy the content and  paste it in the terminal.

   [![wm-rn-web-preview](/learn/assets/wm-rn-web-preview.jpg)](/learn/assets/wm-rn-web-preview.jpg)
