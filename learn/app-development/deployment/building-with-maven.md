...
Either 
  - Go to Studio -> File Explorer -> profiles -> open the file `<profilename.properties>`
  - Or Go to the Project folder -> profiles -> open the file `<profilename.properties>` As shown in the image below:
