...
### [2. What skills are required to build a WaveMaker app?](skills-need-to-build-wavemaker-app.md)

### [3. How does WaveMaker simplify app development using the RAD paradigm?](app-development-using-rad.md)

### [4. How databases work in WaveMaker?](database-in-wavemaker.md)  

### [5. How Web Services work in WaveMaker?](web-services.md)  

### [6. How Java Services work in WaveMaker?](java-services-in-wavemaker.md)  


## What are Widgets in WaveMaker?()
