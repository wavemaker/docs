...
4. You will be directed to the Variables page, with the new variable listed. [![](/learn/assets/dbcrud_varcr_direct_var.png)](/learn/assets/dbcrud_varcr_direct_var.png) As you can see:
...
7. You can see the variable listed Variables dialog [![](/learn/assets/dbcrud_varcr_dt_var.png)](/learn/assets/dbcrud_varcr_dt_var.png) As you can see:
