...
**Page script** can be accessed from the script tab on your project workspace. Using JavaScript, the functionality of your project can be enhanced. The various methods and properties associated with each of the Studio elements can be found in the $${"type":"anchor", "name":"API Documentation", "url":"https://www.wavemakeronline.com/studio/#{wmVersionNumber}#/docs/index.html", "variables":["wmVersionNumber"]}$$.
