...
4. Bind the “URL” and “Entities” (properties of prefab) on your page. 
  * URL is the path of the document(Prefab v1.1 supports `.png` and `.jpg` formats) to download and process. You can bind URL property with [FileUpload](/learn/app-development/widgets/form-widgets/file-upload) widget's java service variable as shown in the below screen.  
