...
The APIs generated by [a SOAP Service](http://[supsystic-show-popup id=115]) are listed in API Designer.

- the will display the details of the methods which include the API URL, description, and the visibility.
...
[![](../assets/API_soap.png)](../assets/API_soap.png)
