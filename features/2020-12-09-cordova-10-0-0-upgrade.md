...
2) [cordova-plugin-local-webserver](/blog/2020/04/20/wavemaker-wkwebview-upgrade)
3) cordova-plugin-transport-security
4) [cordova-plugin-wkwebview-engine](/blog/2020/04/20/wavemaker-wkwebview-upgrade)
