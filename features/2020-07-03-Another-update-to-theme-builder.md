...
Here is another update on the [Theme builder](https://apps.wavemakeronline.com/Theme_Builder/#/Dashboard) app. After the [first release](/blog/2020/06/01/build-themes-without-any-coding) of theme builder, we thought of adding few more features and enhancements to enable our users to create great themes to get their web, mobile applications looking well finished.  
