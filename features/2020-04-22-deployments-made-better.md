...
[![screenshot](/img/blogs/wm-blog-deploy-01-check.png)](/img/blogs/wm-blog-deploy-01-check.png)

* Error state where the user is presented with the link to check the errors which caused failure as shown below.

[![screenshot](/img/blogs/wm-blog-deploy-02-error.png)](/img/blogs/wm-blog-deploy-02-error.png)
...
[![screenshot](/img/blogs/wm-blog-deploy-03-list.png)](/img/blogs/wm-blog-deploy-03-list.png)
...
* It also includes the [documentation](#) link, to help the developer understand the issue better & help in looking for solutions.

[![screenshot](/img/blogs/wm-blog-deploy-04-detail.png)](/img/blogs/wm-blog-deploy-04-detail.png)
