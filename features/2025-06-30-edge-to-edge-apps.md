...
import edge_to_edge_comparison from '/img/blogs/react-native/edge-to-edge-apps/edge_to_edge_comparison.mp4';
import edge_to_edge_page_level_props from '/img/blogs/react-native/edge-to-edge-apps/edge_to_edge_page_level_props.png';
import edge_to_edge_walkthrough from '/img/blogs/react-native/edge-to-edge-apps/edge_to_edge_walkthrough.mp4';
