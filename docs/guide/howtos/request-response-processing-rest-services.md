...
Following is the Request life cycle for a REST Service in a WaveMaker app: Image: REST-request-response.pngThe following request and response processors are provided, by default, for every REST service integrated into WaveMaker Apps.
