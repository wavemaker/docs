...
Image: Prefab_Create1.png

2. Enter Name and Description and click on **CREATE**.
    
Image: Prefab_Create2.png
...
Image: import_resource1.png 

Image: prefab_angui_resource.png 
...
Image: prefab_angui_statvar.png
...
6. Set the following Prefab properties, from the Prefab Settings:
    ...
    Image: prefab_angui_resourcesettings.png
    ...
    - **Add a property**
        ...
        Image: prefab_angui_props.png
        
        Image: prefab_angui_propbind.png
...
Image: prefab_angui_styles.png

8. **Save** and **run** the Prefab.

Image: prefab_angui_run.png
