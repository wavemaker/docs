...
1. Drag and drop liveform and configure liveform by selecting any of the database entities. Click here
2. Click LiveForm Advanced Settings, switch to **Actions** tab and unselect all the actions.
3. Drag and drop Wizard into liveform. Check here.
...
Now perform all the 4 steps explained above at **Form With Wizard**.
