...
2. Create a Model Variable, choose the Is List and add the list values: Image: sel_listvar.png
...
5. The Display field is what the user sees in the list. In this case it is same as the Data field. We will see the case when both are different in the next use case. Image: sel_listvar_props.png
6. The selection made by the user is displayed in a Label widget, by binding the select datavalue to it. Image: sel_list_res.png
