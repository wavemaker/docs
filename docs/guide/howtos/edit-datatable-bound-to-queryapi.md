...
2. To create a **Database API** variable, go to Variables, select **New Variable** and click **Database APIs**.
...
Image: query-variable-creation.png

### Create a Data Table

4. Drag and drop the Data Table widget and bind the [Database API variable](#create-a-database-api-variable) created above.

### Configure Actions

5. Go to the Data Table's Advanced Settings, navigate to the **Actions** tab, and check the **Edit** action.

Image: edit-action-check.png

### Create a Database CRUD Variable

6. Create another variable for the Employee table to update the records. To create a **Database CRUD** variable, go to Variables, select **New Variable** and click **Database CRUD**.
...
Image: onrecordupdate-event.png
