...
Image: authentication_authorization.png

7. Navigate to the File Explorer and open the required profile properties file. 

Image: development_properties.png

8. Update the property security.activeProviders by adding JWS to it. Example: DEMO, JWS.

Image: security_provider_jws_property.png

9.  Invoke an API by passing the ID token as a bearer token. To know how to pass the ID token as a bearer token in the WaveMaker application, see How to Pass Logged-In User ID/Access Tokens as Header.
...
Image: opaque_secondary_provider.png
...
Image: security_dialog_opaque.png
...
Image: developement_properties.png

8. Update the property security.activeProviders by adding OPAQUE_TOKEN to it. Example: DEMO, OPAQUE_TOKEN.

Image: security_active_properties_opaque.png

9. Invoke an API by passing the access token as a bearer token. To know how to pass access token as bearer token in the WaveMaker application, see How to Pass Logged-In User ID/Access Tokens as Header.
