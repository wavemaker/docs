...
1. Create a Model Variable of Entry Type, with Is List option selected and using the following JSON structure:
...
Image: rating_usage_statvar.png
...
Image: rating_usage_statvar_bind.png
