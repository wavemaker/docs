...
Image: config_howto_appenv1.png
...
Image: config_howto_appenv2.png

## How to use
There are three ways to use the app environment values:

1.  set them as data type values for the Database entities (for more)  

Image: config_howto_appenv3a.png

2.  You can use it to set the parameter values for queries and procedures (for more details)  

Image: config_howto_appenv3b.png
...
Image: config_howto_appenv3.png
