...
Image: liveform_filtercriteria1.png
...
- **Quick Edit and Inline Editable Data Tables**
    ...
    Image: datatable_filtercriteria1.png 
    
    Image: datatable_filtercriteria2.png

- **Live Filter**
    
    - You might have to set the Widget to Select to enable the Filter Criteria option.
    
    Image: livefilter_filtercriteria.png
