...
!/learn/assets/microfrontends-iframes/hr-app.png
...
!/learn/assets/microfrontends-iframes/employee-app.png
...
!/learn/assets/microfrontends-iframes/department-app.png
...
4. At runtime, access the localhost and navigate to the department page, we will see that the iframe loads the department as expected.  
 ...
 !/learn/assets/microfrontends-iframes/hr-final-app.png
