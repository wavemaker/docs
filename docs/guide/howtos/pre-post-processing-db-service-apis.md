...
:::note
The following procedure specified in this document will no longer work. We recommend you follow Database CRUD Operations Event Listeners instead.
:::
...
- Import a database service: (we are using the sample HRDB) 

Image: hrdb.png

- Set Security to On. Use Database as Security Provider and Configure Security with user table of HRDB.
...
Image: word-image-160.png 

Please refer the documentation to add the files in project.
