...
1. The column names need to be added in the localization i.e., i18n dialog as message keys
    ...
    3. add the column names as message key in multiple languages.
        Image: locale_dt1.png
2. Open the Advanced Settings of the data table widget and navigate to the Columns tab. Image: locale_dt2.png
3. Bind the respective message keys to the "Title" property of the columns. Image: locale_dt3.png
