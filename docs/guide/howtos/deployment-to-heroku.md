...
3. Add a Heroku’s _Procfile_ to WaveMaker App
    ...
    2. Upload it to the root of WaveMaker project using the **Import -> Resource** menu Image: heroku_import_resource1.png Image: heroku_import_resource2.png
4. Set up app in External Github Repository
    1. Push your application to External Repository Image: heroku_git_repo1.png
    2. Push changes if prompted Image: heroku_git_repo2.png
    3. Provide your GitHub credentials and a new repository name. Image: heroku_git_repo3.png
    4. The repository will be created and code will be pushed to your GitHub account. Image: heroku_git_repo4.png

## Create and Configure Heroku application

1. Create a new application in Heroku. Image: heroku_create_app.png
2. Connect Heroku application to GitHub. Image: heroku_connect_app1.png
3. Provide GitHub project name and connect. Image: heroku_connect_app2.png
4. From Settings Add buildpack Image: heroku_buildpack.png
5. Select Java and Save changes Image: heroku_buildpack2.png

## Deploy and run the application

1. From the Deploy tab, Deploy Manually. Image: heroku_deploy1.png
2. Open Heroku application after the deployment is done. Image: heroku_deploy2.png
3. Your app is now running in Heroku
4. Finally, enable auto deployment. Any push to GitHub repository will automatically deploy your application now. Image: heroku_deploy3.png
