...
1. From the Variable menu create a Model Variable.
...
4. Drag and drop a Dropdown Menu widget on the canvas (more on Dropdown Menu)
...
5. Open the I18N dialog from the Project Configurations of the Project Workspace (more on localization). Image: loc_create.png
    ...
    Image: menu_locale.png

    4. Repeat the process for all the messages keys. 
    
    Image: menu_locale_messages.png

6. Drag and drop a Select Locale widget onto the canvas. The Select Locale widget auto-populates the languages added from the I18N dialog as a drop-down. (more on Select Locale widget)
