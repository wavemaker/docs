...
Image: AD_case1-1.png**Scenario 2**: Support for user search using sAMAccountName.
...
Image: AD_case2-1.png**Scenario 3**: Support for users with certain domain name suffix
