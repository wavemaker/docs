...
Click here to see How-to use Jasper connector in WaveMaker  App
:::
...
3. The `jrxml` file has to be created as per your database. Import the `jrxml` file to `projects/src/main/resources`. For the above database, we have used the following employee.

## Steps in Integration

1. Java Service Integration will create sample Java Service.
...
5. Create a Java Service Variable with the following. 
