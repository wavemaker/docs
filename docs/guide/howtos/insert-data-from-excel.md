...
1. Import the downloaded excel-connector zip into your app using the Import Resource option to the **_Connector_** folder.

## Step 2: Import a databaseService

1. In this example using excel connector we will be inserting data to HRDB User table
1. Import Sample HRDB
...
1. How to send emails using Java Service
1. How to implement forgot password feature using Java Service
1. How to access REST APIs from Java Service
1. How to schedule a Java Service
1. How to accomplish Pre-Post Processing for a DB Service APIs
