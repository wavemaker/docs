...
Image: auth0-dashboard.png

3. Go to **Applications** > **Applications**.

Image: auth0-applications-applications.png
...
Image: create-applications-confirm.png

### Configuring Application

1. Once Web Application is created, select **Java** as technology used in your project.

Image: auth0-application-technology.png

2. Go to **Settings** > **Advance Settings**.

Image: auth0-application-advancesettings.png
...
Image: auth0-redirectURL.png

4. Click **Save Changes** to save the given details.

Image: auth0-application-savechanges.png\
...
Image: auth0-client-details.png
