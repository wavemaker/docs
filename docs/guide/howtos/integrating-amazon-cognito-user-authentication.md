...
4. From the Apps tab, create an application with following configuration, make sure that “Generate Client Secret” is unchecked Image: AC_poolapp.png
...
Image: AC_js_code.png

4. Configure the Security with provider as Custom and give the above Class Name.
