...
WaveMaker Apps can be exported as a WAR file. This generated file can be deployed to any standard Java Web Server running on JDK 17/JDK 21. For more information, see Deployment to Web Server.
...
Image: weblogic3.png
4. Select '_Install this deployment as an application_' and click the _Next_ button.Image: weblogic4.png
