...
Image: dt_export.png
3. **Export Data Size** property can be used to specify the number of records to be exported. By default, the value is set to 100, the maximum export size. To export more than 100 records, change the max size from the Project Configurations menu in the Project Workspace.
