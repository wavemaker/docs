...
3. The Prefab will be available for use across the Projects. You can see the entry in the !Artifacts list and in the Widget Toolbox of any Project within your workspace.
