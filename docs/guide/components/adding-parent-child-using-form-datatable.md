...
[![model variable](./assets/img/model-variable.png)](./assets/img/model-variable.png)
...
[![Form Data Table](./assets/img/form-datatable.png)](./assets/img/form-datatable.png)

Click the New button and add the Address Details. Likewise, you can add any number of address details using Data Table.

[![Form table data](./assets/img/form-table-data.png)](./assets/img/form-table-data.png)
...
[![Form table object](./assets/img/form-table-object.png)](./assets/img/form-table-object.png)