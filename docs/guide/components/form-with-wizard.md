...
1. Drag and drop liveform and configure liveform by selecting any of the database entities. [Click here](../../user-interfaces/web/components/angular-components/datalive/live-form/live-form-basic-usage.md)
2. Click LiveForm Advanced Settings, switch to **Actions** tab and unselect all the actions.
3. Drag and drop Wizard into liveform. [Check here](../../user-interfaces/web/components/angular-components/container/wizard.md).
...
[![](./assets/img/wizardevent.png)](./assets/img/wizardevent.png)
...
[![](./assets/img/empdb.png)](./assets/img/empdb.png)

Now perform all the 4 steps explained above at [**Form With Wizard**](./form-with-wizard.md#form-with-wizard).
...
[![](./assets/img/empform.png)](./assets/img/empform.png)
