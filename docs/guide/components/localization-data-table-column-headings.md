...
1. The column names need to be added in the localization i.e., i18n dialog as message keys
    ...
    3. add the column names as message key in multiple languages.
        [![](./assets/img/locale_dt1.png)](./assets/img/locale_dt1.png)
2. Open the Advanced Settings of the data table widget and navigate to the Columns tab. [![](./assets/img/locale_dt2.png)](./assets/img/locale_dt2.png)
