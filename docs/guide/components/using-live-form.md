...
Drag and drop the **Live Form** widget on to the page. [![lf_sel](./assets/img/lf_sel.png)](./assets/img/lf_sel.png)
...
[![lf_data](./assets/img/lf_data.png)](./assets/img/lf_data.png)
...
[![lf_layout](./assets/img/lf_layout.png)](./assets/img/lf_layout.png)
...
[![lf_field](./assets/img/lf_field.png)](./assets/img/lf_field.png)
