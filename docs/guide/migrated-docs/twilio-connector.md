...
2. Import the downloaded twilio connector zip into your app using the [Import Resource](/docs/apis-and-services/apis/third-party-libraries/jar-files) option to the **Connector** folder.
