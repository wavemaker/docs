...
[How to change the default app favicon](/docs/guide/migrated-docs/changing-default-favicon)  
[How to set the app logo](/docs/guide/migrated-docs/changing-app-logo)  
[How to incorporate additional icons](/docs/guide/migrated-docs/incorporating-additional-icons)  
[How to conditionally change the color of icons](/docs/guide/migrated-docs/displaying-icon-color-based-upon-condition)  
[How to change the page title](/docs/guide/migrated-docs/changing-page-title)  
[How to customise the app login page](/docs/guide/migrated-docs/customise-login-page)  
