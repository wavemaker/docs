...
WaveMaker Apps can be exported as a WAR file. This generated file can be deployed to any standard Java Web Server running on JDK 17/JDK 21. For more information, see [Deployment to Web Server](/docs/build-and-deploy/deploy/deploy-to-web-server).
...
Export Project as war. For steps in war file generation for WaveMaker apps, see [War file generation](/docs/build-and-deploy/deploy/deploy-to-web-server#generate-a-war-file).
