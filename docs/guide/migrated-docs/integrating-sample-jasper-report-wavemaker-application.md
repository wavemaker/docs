...
[Click here to see How-to use Jasper connector in WaveMaker  App](/docs/guide/migrated-docs/generate-pdf-file-using-jasper-reports)
:::
...
-  To Integrate Jasper Reports in your WaveMaker application you will need to write the Java Service where by passing required parameters one can generate the report. [Refer the link for creating Java service](/docs/apis-and-services/apis/building-custom-apis/java-integration-services).
...
3. The `jrxml` file has to be created as per your database. [Import](/docs/apis-and-services/apis/third-party-libraries/jar-files) the `jrxml` file to `projects/src/main/resources`. For the above database, we have used the following [employee](/learn/assets/employee.zip).

## Steps in Integration

1. [Java Service Integration](/docs/apis-and-services/apis/building-custom-apis/java-integration-services) will create sample Java Service.
