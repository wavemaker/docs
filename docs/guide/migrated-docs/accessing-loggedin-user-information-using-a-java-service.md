...
For more information to add files in a project, see [including resource files](/docs/apis-and-services/apis/third-party-libraries/jar-files#including-resource-files).
...
- Create a [Java Service variable](/docs/user-interfaces/mobile/develop/integrating-with-apis/variables) to access this service method to get the list of user details.
...
[How to access REST APIs from Java Service](/docs/guide/migrated-docs/accessing-rest-apis-java-service)  
