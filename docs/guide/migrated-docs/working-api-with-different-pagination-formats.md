...
1.  [Create a javaservice](/docs/apis-and-services/apis/building-custom-apis/java-integration-services#creating-a-java-service) and specify a name to the service (let's say employeeService)
