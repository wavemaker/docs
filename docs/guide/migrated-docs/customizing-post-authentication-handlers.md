...
Post authentication, the default Redirection Handler redirects to the appropriate [landing page](/docs/apis-and-services/security/providers/login-configuration#setting-landing-page) based upon the logged-in users' role.
