...
1. Import the downloaded excel-connector zip into your app using the [Import Resource](/docs/apis-and-services/apis/third-party-libraries/jar-files) option to the **_Connector_** folder.
...
1. Create a [Java Service](/docs/apis-and-services/apis/building-custom-apis/java-integration-services#creating-a-java-service), named ExcelService
...
1. [How to send emails using Java Service](/docs/guide/migrated-docs/sending-email-using-java-service)
1. [How to implement forgot password feature using Java Service](/docs/guide/migrated-docs/implementing-forgot-password-feature-using-java-service)
1. [How to access REST APIs from Java Service](/docs/guide/migrated-docs/accessing-rest-apis-java-service)
1. [How to schedule a Java Service](/docs/guide/migrated-docs/scheduling-java-service)
1. [How to accomplish Pre-Post Processing for a DB Service APIs](/docs/guide/migrated-docs/pre-post-processing-db-service-apis)
