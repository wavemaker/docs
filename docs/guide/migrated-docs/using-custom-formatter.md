...
With [Custom Formatter](/docs/user-interfaces/mobile/develop/integrating-with-apis/variables), customize data more specific to your audience. Convert data received from services to well-formatted data before showing it in the UI, depending on the role, country, currency, and more. In this example, we are using a [Card Widget](#) to show how it works.

:::note
For more information about Custom Formatter syntax and definition, see [Custom Formatter](/docs/user-interfaces/mobile/develop/integrating-with-apis/variables).
:::

## Drag and Drop the Widget

1. Drag and drop a Card widget, and [bind the widget](/docs/user-interfaces/web/develop/integrating-with-apis/variables#binding-to-widgets) to a dataSet. In this example, we are using a [model variable](/docs/user-interfaces/mobile/develop/integrating-with-apis/variables) with the following static data.
...
:::tip
For more information about the syntax, see [Custom Formatter Syntax Definition](/docs/user-interfaces/mobile/develop/integrating-with-apis/variables#syntax-definition).
:::
...
8. For the roles to work, enable [Authentication](/docs/apis-and-services/security/app-security). In this case, we are using the [Demo security provider](/docs/apis-and-services/security/app-security#demo). Enable these settings and come back to the **Use Expression** dialog.
...
[Custom Formatter](/docs/user-interfaces/mobile/develop/integrating-with-apis/variables)  