...
1. Enable Security in WaveMaker app [Check here](/docs/apis-and-services/security/app-security)

2. Write Success handler on authentication success [Check here](/docs/guide/migrated-docs/customizing-post-authentication-handlers).
...
Check how to integrate twilio-connector and access API's into your app from [Check here](/docs/guide/migrated-docs/twilio-connector)

Create JavaService and integrate twilio one-time passcode API's in the application [Check here](/docs/guide/migrated-docs/twilio-connector#implementing-otp)
