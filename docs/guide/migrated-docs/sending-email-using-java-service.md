...
- Import the downloaded email-connector zip into your app using the [Import Resource](/docs/apis-and-services/apis/third-party-libraries/jar-files) option to the **Connector** folder.
...
- Create a [Java Service](/docs/apis-and-services/apis/building-custom-apis/java-integration-services#creating-a-java-service), named EmailService
...
[How to send emails using Java Service](/docs/guide/migrated-docs/sending-email-using-java-service)  
[How to implement forgot password feature using Java Service](/docs/guide/migrated-docs/implementing-forgot-password-feature-using-java-service)  
[How to schedule a Java Service](/docs/guide/migrated-docs/scheduling-java-service)  
[How to accomplish Pre-Post Processing for a DB Service APIs](/docs/guide/migrated-docs/pre-post-processing-db-service-apis)
