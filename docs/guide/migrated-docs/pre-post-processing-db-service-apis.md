...
- [Set Security to On](/docs/apis-and-services/security/app-security). Use Database as Security Provider and Configure Security with user table of HRDB.
...
Please refer the [documentation](/docs/apis-and-services/apis/third-party-libraries/jar-files#resource-files) to add the files in project.
