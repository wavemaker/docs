...
1. Configure the security provider from the Security dialog. To know more, see [Selecting Security Providers](/docs/apis-and-services/security/app-security#selecting-security-providers).
