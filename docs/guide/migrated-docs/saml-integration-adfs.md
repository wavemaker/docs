...
2. You have the Metadata URL for the WaveMaker App: Steps to obtain the Metadata URL:
    1. You should have already created an app using WaveMaker integrated with SAML as security provider ([see here for more](/docs/apis-and-services/security/providers/saml-integration#integration)).
...
1. Get the deployment URL from [Profile Configuration dialog](#) [![](/learn/assets/adfs_wm_deploy.png)](/learn/assets/adfs_wm_deploy.png)
...
[App Security Cases](/docs/apis-and-services/security/app-security)

- [1. How to integrage SAML with OneLogin](/docs/guide/migrated-docs/saml-integration-onelogin)
- [2. How to integrage SAML with ADFS](/docs/guide/migrated-docs/saml-integration-adfs)
