...
We are proceeding with the assumption that you have a user registration page designed for your app. For steps in creating a registration page, see [Creating Registration Page](/docs/guide/migrated-docs/creating-registration-page).
...
- [Create a Java service](/docs/apis-and-services/apis/building-custom-apis/java-integration-services) and mention the following method. This would take the plain text as input and generates “Salt” for every plain text that is being encrypted. Dont forget to include the import statement
```    
...
```    
- [Create a variable](/docs/user-interfaces/mobile/develop/integrating-with-apis/variables) for the above Java service and bind the input parameter of the Java service variable to the _`password text widget >> datavalue`_ of the registration form.
...
- [Import the `myPasswordEncoder` Java file](/docs/apis-and-services/apis/third-party-libraries/jar-files) in the following path: `project/src/main/java/com/wavemaker/runtime/security/provider/database/` 
...
## See Also 
[Creating Registration Page](/docs/guide/migrated-docs/creating-registration-page)  
[Java Services](/docs/apis-and-services/apis/building-custom-apis/java-integration-services)  
[Create Variable](/docs/user-interfaces/mobile/develop/integrating-with-apis/variables)  
[3rd Party Libraries](/docs/apis-and-services/apis/third-party-libraries/jar-files)  
