...
For more information, see [Working with Live Filter](/docs/guide/components/live-filter-applying).
...
[How to set validations using CRUD Listeners](/docs/guide/migrated-docs/validations-using-crudListeners)  
[How to audit History using CRUD Listeners](/docs/guide/migrated-docs/audit-history-using-crud-listeners)  
[How to write custom business logic using CRUD Listeners](/docs/guide/migrated-docs/custom-business-logic-using-crud-event-listeners)  
