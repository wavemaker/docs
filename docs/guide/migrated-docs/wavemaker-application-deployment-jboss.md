...
From WaveMaker Studio, for the app that you want to deploy to JBoss, Export the app as WAR file using the appropriate configurations. For more information, see [Generate a WAR file](/docs/build-and-deploy/deploy/deploy-to-web-server#generate-a-war-file).
