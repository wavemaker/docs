...
2.  You can use it to set the parameter values for queries and procedures ([for more details](/docs/apis-and-services/apis/database-and-crud-apis/queries-and-procedures#query-creation-parameterised))  
