...
- [1. How to use search widget within leftnav](/docs/guide/migrated-docs/using-search-widget-within-navbar)
- [2. How to add sliding leftnav](/docs/guide/migrated-docs/sliding-leftnav-mobile-app)
