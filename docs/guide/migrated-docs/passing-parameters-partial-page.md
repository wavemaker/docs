...
[Design UI Cases](#)   
[How to pass parameters to pages](/docs/guide/migrated-docs/passing-parameters-pages)  
[How to use static variable to pass data between pages](/docs/guide/migrated-docs/use-static-variable-pass-data-pages)  
