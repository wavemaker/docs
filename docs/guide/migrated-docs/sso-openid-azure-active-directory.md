...
For more information about role mapping, see [Role Mapping in OpenID](/docs/apis-and-services/security/app-security#role-mapping-3)

## See Also

[Aunthentication in WaveMaker](/docs/apis-and-services/security/app-security#openid)  
