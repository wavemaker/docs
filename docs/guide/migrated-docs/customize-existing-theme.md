...
[How to change background of an application](/docs/guide/migrated-docs/customizing-theme#changing-background-of-an-application)  
[How to use web fonts in theme](/docs/guide/migrated-docs/customizing-theme#using-web-fonts-in-a-theme)  
[How to style app components](/docs/guide/migrated-docs/customizing-theme#style-the-components-of-wavemaker-app)  
