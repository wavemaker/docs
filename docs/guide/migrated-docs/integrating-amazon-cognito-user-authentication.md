...
1. Upload the JS files to WaveMaker. Go to [Import Resource](/docs/apis-and-services/apis/third-party-libraries/jar-files) and Upload the JS files downloaded in the previous section. The files should be uploaded to `project/src/main/webapp/` directory.
...
1. [Create a Java Service](/docs/apis-and-services/apis/building-custom-apis/java-integration-services) - CognitoUPoolLogin.
...
4. [Configure the Security](/docs/apis-and-services/security/app-security) with provider as Custom and give the above Class Name.
