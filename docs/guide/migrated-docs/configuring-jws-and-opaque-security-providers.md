...
The role attribute is configured using the JWS or database. To know more about role mapping, see [Role Mapping](/docs/apis-and-services/security/app-security#role-mapping).
...
9.  Invoke an API by passing the ID token as a bearer token. To know how to pass the ID token as a bearer token in the WaveMaker application, see [How to Pass Logged-In User ID/Access Tokens as Header](/docs/guide/migrated-docs/passing-id-access-tokens-as-header).
...
The role attribute is configured using the Opaque token or database. To know more about role mapping, see [Role Mapping](/docs/apis-and-services/security/app-security#role-mapping).
...
9. Invoke an API by passing the access token as a bearer token. To know how to pass access token as bearer token in the WaveMaker application, see [How to Pass Logged-In User ID/Access Tokens as Header](/docs/guide/migrated-docs/passing-id-access-tokens-as-header).
