...
1. To begin with the process, you start by adding a custom formatter. To know more, see [Apply Custom Data Formatter](/docs/guide/migrated-docs/using-custom-formatter).
