...
WaveMaker Apps can be exported as a WAR file. This generated file can be deployed to any standard Java Web Server running on JDK 17/JDK 21. This section walks through the steps to deploy WaveMaker app to **JBoss - WildFly**.
## Prerequisites
...
From WaveMaker Studio, for the app that you want to deploy to JBoss, Export the app as WAR file using the appropriate configurations. For more information, see [Generate a WAR file](../../../build-and-deploy/build/web/package/war/build-war-from-projectzip.md).
...
![JBoss JNDI Configuration](../assets/JBoss_JNDI1.png)
- Export war for the newly created profile. 
![JBoss JNDI Configuration](../assets/JBoss_JNDI2.png)
- Save the war file
...
![troubelshoot](../assets/JBoss_troubleshoot.png)
