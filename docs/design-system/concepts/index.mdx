...
![design to code](./assets/img/design-to-code-architecture.png)
...
1. Update the primary color token in [Style Workspace](./working-with-style-workspace).
...
Learn more about the [Design Token architecture here](./design-token-architecture). 
...
<summary>Behind the Scenes: What is the role of Amazon Style Dictionary in the WaveMaker design token system?</summary>
