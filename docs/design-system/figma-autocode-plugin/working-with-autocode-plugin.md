...
At the bottom of the Figma design canvas, toggle the last button in the toolbar to switch to Dev Mode.
    ...
    ![switching to dev mode](./assets/img/switch_to_dev.png)

### 2. Open the Plugin

In the **right panel**, go to the **Plugins tab**

![switching to plugins tab](./assets/img/switch_to_plugins.png)

Search for **WaveMaker Autocode Plugin** and click **Run**.
    
![launch plugin](./assets/img/search_plugin.png)

### 3. Generate Code

Select the pages you want to process and click **Run Autocode Plugin**. The plugin will process the selected pages.

![select pages and run plugin](./assets/img/select_pages.png)
...
![ready for preview](./assets/img/preview_complete.png)
...
![output preview](./assets/img/preview_screens.png)

![code preview](./assets/img/preview_code.png)
...
![locate edit in WaveMaker button](./assets/img/edit_in_wm.png)
