...
![examples of single child alignment inside frame with auto layout](./assets/img/one_child.png)

![prefered alignments for single child frames](./assets/img/alignment_center_top.png)
...
![example of incorrect application of instance property](./assets/img/properties_wrong_border.png)

![example of correct application of instance property](./assets/img/properties_right_border.png)
