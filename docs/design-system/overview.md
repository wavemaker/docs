...
### [Concept](./concept/design-tokens)
Fundamental design system concepts and principles:
- [Design Tokens](./concept/design-tokens) - Design decision variables
- [Component Variants](./concept/component-variants) - Component variations and patterns
- [Designing Best Practices](./concept/designing-best-practices) - Best practices for design systems
...
### [Design System based UI Development](./design-system-based-ui-development/style-workspace)
Implementation and development guides:
- [Style Workspace](./design-system-based-ui-development/style-workspace) - Styling tools and approaches
...
### For Designers
1. Review [Concept](./concept/design-tokens) documentation
2. Explore the UI KIT component library
3. Study [Designing Best Practices](./concept/designing-best-practices)
4. Access design files and assets
5. Follow contribution guidelines

### For Developers
1. Install the design system package
2. Review [Design System based UI Development](./design-system-based-ui-development/style-workspace)
...
- [Build and Deploy](../build-and-deploy/overview) - Build and deployment strategies
- [Testing and Debugging](../apis-and-services/testing-and-debugging/unit-testing/integrate-junit-tests) - Testing strategies
