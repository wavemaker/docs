...
Once a database is connected, WaveMaker automatically generates CRUD APIs for selected tables and views. These APIs are managed and exposed through the  **[API Workspace](../../../studio/Workspaces/api_workspace.md)**
...
Learn more: [Queries and Procedures](./queries_and_procedures.md)
...
Learn more: [WaveMaker Generated Backend Architecture](./orm_artifacts.md)
