...
WaveMaker's **Java Integration Services** let you leverage existing backend services within your custom Java code. Using dependency injection, you can access database services, security services, feed services, and SOAP services directly from Java Services. This enables stronger integration, reuse of generated services, and more advanced backend logic.

> **Note:** You cannot invoke imported REST services directly using this mechanism—only services generated by WaveMaker such as database services, SOAP services, feed services, and security services can be autowired.
...
Add external JARs as project resources and reference them in your Java Service code.
