...
- **Integration:** Connect with external REST/SOAP APIs, messaging systems, or cloud services.  
...
##  Typical Steps to Build a Custom API

### 1. Create a Java Service
...
This service acts as the foundation for implementing custom business logic that cannot be handled using out-of-the-box services.
...
Once a Java Service is saved, it becomes available as a **REST API** in the **API Designer**[API workspace](../../../studio/Workspaces/api_workspace.md) 
