...
:::note
From [WaveMaker 10.13.0](#), Datatable columns render plain text to prevent XSS attacks. Before this change, the content was rendering HTML format.
:::
...
![Rendering HTML in table](../assets/preview4.png)
...
![Rendering HTML in table](../assets/preview.png)
...
![Rendering HTML in table](../assets/formatters.png)
...
![Rendering HTML in table](../assets/preview2.png)
...
![Rendering HTML in table](../assets/preview3.png)
