...
2. Few things that you need to be aware of regarding the landing page configured here and the home page configured in the [Project Settings](#) dialog ([Settings accessed from the Project Configurations of Workspace](#)):
