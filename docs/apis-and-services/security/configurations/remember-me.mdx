...
It can be disabled by updating:
- `auth-info.json`
...
The remember-me cookie remains valid until:
- **15 days** have elapsed from creation, or
- The user explicitly signs out of the application  
