...
This overview introduces the WaveMaker security model and explains how authentication, user onboarding, and authorization work together to secure application pages, services, and APIs.
...
**Learn more:** [Security Workspace](../../studio/workspaces/security-workspace.md)
