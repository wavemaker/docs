...
2. Create Backend-for-Frontend (BFF) APIs
...
Create BFF APIs leveraging existing imported REST or Open APIs, by orchestrating them with custom business logic. API latency is a very critical factor for web and mobile application performance.

BFF APIs solves the following problems:
