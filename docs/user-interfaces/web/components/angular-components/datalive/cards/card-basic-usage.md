...
[![](./assets/img/cards_basic_run.png)](./assets/img/cards_basic_run.png)

To bind the Cards to your back-end services data, drag and drop the Cards Widget onto the canvas. [![](./assets/img/cards_sel.png)](./assets/img/cards_sel.png)
...
[![](./assets/img/cards_basic_data1.png)](./assets/img/cards_basic_data1.png)  
...
[![](./assets/img/cards_basic_data2_1.png)](./assets/img/cards_basic_data2_1.png)
...
[![](./assets/img/cards_basic_data2_2.png)](./assets/img/cards_basic_data2_2.png)
...
If the variables are already created in the project, [Variable Access](../../assets/img/var_sel.png).
...
[![](./assets/img/cards_basic_data3_1.png)](./assets/img/cards_basic_data3_1.png)
...
[![](./assets/img/cards_basic_data3_2.png)](./assets/img/cards_basic_data3_2.png)
...
[![](./assets/img/cards_basic_data4_1.png)](./assets/img/cards_basic_data4_1.png)
...
[![](./assets/img/cards_basic_data4_2.png)](./assets/img/cards_basic_data4_2.png)
...
[![](./assets/img/Card_template.png)](./assets/img/Card_template.png)

### `Select B: pagination`
Choose one of the pagination options provided. 

[![](./assets/img/Card_pag.png)](./assets/img/Card_pag.png)
...
[![](./assets/img/cards_basic_fields.png)](./assets/img/cards_basic_fields.png)

## Design

You can add widgets from the canvas, change the properties at the card and at widget level.

[![](./assets/img/cards_basic_design.png)](./assets/img/cards_basic_design.png)
