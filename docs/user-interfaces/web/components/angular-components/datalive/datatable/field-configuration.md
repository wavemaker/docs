...
[![](./assets/img/AS_fields.png)](./assets/img/AS_fields.png)

### Column Grouping

This feature helps you group columns under a heading for better readability and convenience. [![](./assets/img/group_run.png)](./assets/img/group_run.png)

1. Use the **Add Group** button under _Columns_ tab of _Advanced Settings_. This will allow you to give a title to the group. [![](./assets/img/group_new.png)](./assets/img/group_new.png)
2. **Add columns**  to the group by either
    ...
    - by selecting the _Group_ from the Basic properties tab [![](./assets/img/group_add.png)](./assets/img/group_add.png)
3. You can also have nested groups by selecting the parent group while adding the group or use the drag feature. [![](./assets/img/group_nested.png)](./assets/img/group_nested.png) [![](./assets/img/group_nested_final.png)](./assets/img/group_nested_final.png)

### View Mode Options

[![](./assets/img/dt_cols_view.png)](./assets/img/dt_cols_view.png)
...
[![](./assets/img/dt_cols_format.png)](./assets/img/dt_cols_format.png)
...
1. **Display options** include:
    ...
    [![](./assets/img/dt_cols_edit.png)](./assets/img/dt_cols_edit.png)
2. **Validation options**:
    ...
    [![](./assets/img/dt_cols_validations.png)](./assets/img/dt_cols_validations.png)
...
[![](./assets/img/dt_cols_filter.png)](./assets/img/dt_cols_filter.png)
