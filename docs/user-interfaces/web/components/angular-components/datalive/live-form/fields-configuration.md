...
[![](./assets/img/LF_Fields.png)](./assets/img/LF_Fields.png)
...
5. For **Date Type fields**, **Min Date, Max Date, Exclude Days and Dates** can be set. In this case, the date picker will not have the invalid dates available for selection. [![](../form/assets/img/LF_valid.png)](../form/assets/img/LF_valid.png)
6. You can invoke the **hightlightInvalidFields** method on _Save_ action from the Advanced Settings, to highlight all invalid fields in red and display appropriate error messages. [![](./assets/img/AS_actions_valid.png)](./assets/img/AS_actions_valid.png)
...
3. In fields configuration step, change the required field widget type to Select. [![](./assets/img/lf_widget_fields.png)](./assets/img/lf_widget_fields.png)
4. Select the field from the canvas.
5. The dataset for the form field widget is auto populated with the Variable Dataset field. Data field and display field is set to field’s key. Here, the dataset value can be bound to any other variable or widget. [![](./assets/img/lf_widget_propss.png)](./assets/img/lf_widget_propss.png)
6. The widget can be changed from Live Form Advanced Settings also. [![](./assets/img/lf_widget_AS.png)](./assets/img/lf_widget_AS.png)
7. Now, at runtime, the user can use this widget to select a value from predefined options. [![](./assets/img/lf_widget_run.png)](./assets/img/lf_widget_run.png)
