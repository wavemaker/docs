...
[![](./assets/img/buttongroup_graphic.jpg)](./assets/img/buttongroup_graphic.jpg)

## Properties

Refer to  [Button widget document](./button.md) for individual Button features and properties.
