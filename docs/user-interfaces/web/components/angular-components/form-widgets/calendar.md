...
| View | This property allows you to set the default view of the calendar widget:   - month (default),   - week or   - day.    |
...
[How to create an event and save it in a Database](../../../../../guide/components/calendar-usage-create-event.md)  
[How to integrate with Google Calendar](../../../../../guide/components/calender-usage-google-calendar-integration.md)
