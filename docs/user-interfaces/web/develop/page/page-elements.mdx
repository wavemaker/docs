...
In WaveMaker Studio, every page is designed and managed through the **Canvas**. On the top-left corner of the Canvas, you’ll find a dropdown with three options: **Markup, Script, and Style**. These options represent the core building blocks of a WaveMaker page and define how a page is structured and managed.
