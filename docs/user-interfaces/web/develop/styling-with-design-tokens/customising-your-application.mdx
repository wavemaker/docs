...
When new variants are created, the generated styles in `app.override.css` behave differently. Instead of replacing existing rules, these styles introduce new selectors and definitions that extend the component’s capabilities.
