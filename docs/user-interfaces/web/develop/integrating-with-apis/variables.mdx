...
| **Model**          | Defines custom data structures for temporary storage and UI state management. Independent of backend services, useful for managing client-side data within the application. |
...
### Steps
1. Open the **Variables** tab at the App or Page level.
