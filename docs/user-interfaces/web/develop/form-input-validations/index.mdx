...
This is called **Validation**. When you enter data, the browser will check that the data is in the correct format and within the constraints set by the application. 
