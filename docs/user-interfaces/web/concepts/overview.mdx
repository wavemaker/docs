...
- UI Events - initiated by end user interactions such as mouse click, keystroke, tap or touch events
- Lifecycle and State change events such as onChange, onLoad, onSuccess etc., for components, variables, actions, page and application
