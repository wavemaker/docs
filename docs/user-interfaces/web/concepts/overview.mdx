...
- UI Events - initiated by end user interactions such as mouse click, key press, tap or touch events
...
Application code generated in Angular or React adheres to Single Page Application construct and uses architectural principles from the underlying javascript framework such as components, routing, state management, dependency injection, virtual-DOM or 2-way binding etc. Platform generated code is readable, maintainable and secure for enterprise deployments.
