...
| **wm_theme_agent**    | [Theme Agent]()     | Theme agent. Manages global design tokens and theme variants (Material 3). Controls colors, typography, spacing, and light/dark overrides centrally. |
