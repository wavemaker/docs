...
[![Launchpad Logs Click](./assets/images/launchpad-logs-click.png)](./assets/images/launchpad-logs-click.png)

3. It opens the Kibana home page. The home page should look like the below image.

[![Kibana Home Page](./assets/images/kibana-home.png)](./assets/images/kibana-home.png)

4. To search for logs using Kibana, go to "**Discover**" located in the left navigation bar.

[![Kibana Discover Click](./assets/images/kibana-discover-click.png)](./assets/images/kibana-discover-click.png)

5. Finally, you should see the following screen.

[![Kibana Discover Page](./assets/images/kibana-discover-open.png)](./assets/images/kibana-discover-open.png)
...
[![Filter Icon](./assets/images/filter.png)](./assets/images/filter.png)

- Below screenshot displays the searched filter results of edn-services.

[![Filter Icon](./assets/images/container-service.png)](./assets/images/container-service.png)
...
[![Filter Icon](./assets/images/micro-service.png)](./assets/images/micro-service.png)
...
[![Kibana Home Page](./assets/images/kibana-add-filter-clicked.png)](./assets/images/kibana-add-filter-clicked.png)

2. Use `log-level.keyword` as the filter type.

[![Kibana Home Page](./assets/images/kibana-filter-name-type.png)](./assets/images/kibana-filter-name-type.png)

3. Select `is` as the operation.

[![Kibana Home Page](./assets/images/kibana-filter-operation-select.png)](./assets/images/kibana-filter-operation-select.png)

4. Type `INFO` in the value field.

[![Kibana Home Page](./assets/images/kibana-filter-value.png)](./assets/images/kibana-filter-value.png)
...
[![Kibana Home Page](./assets/images/kibana-message-field-add.png)](./assets/images/kibana-message-field-add.png)

6) Finally, this is what it should look like.

[![Kibana Home Page](./assets/images/kibana-final.png)](./assets/images/kibana-final.png)
...
- Select Discover from the Kibana and add the Filter by selecting  **tag.keyword**. A drop down with the list of microservices will display. Select the microservice ex:lbaccess log and save to apply the filter.
  ...
  [![Filter Icon](./assets/images/micro-services.png)](./assets/images/micro-services.png)

- Below screenshot displays the searched filter results of lbaccess log.

  [![Filter Icon](./assets/images/lb-log.png)](./assets/images/lb-log.png)
...
- Select Discover from the Kibana and apply the Filter by selecting **status.keyword**. A drop down with the list of status codes will display. Select the status code and save to apply the filter. The below screenshot displays the searched filter results of status code 200.
  ...
  [![Filter Icon](./assets/images/status-code.png)](./assets/images/status-code.png)
