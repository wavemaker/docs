...
- Preparing the Infrastructure using VMware Esxi for WME setup with required [system prerequisites](/docs/studio/offerings/wme/getting-started/prerequisites).
