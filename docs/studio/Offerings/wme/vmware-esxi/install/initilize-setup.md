...
- If you want to provide your own user, create a user with specified [prerequisites](/docs/studio/Offerings/wme/prerequisites) and ensure that the user has SSH access.
