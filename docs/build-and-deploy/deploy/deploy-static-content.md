...
## Overview
The frontend code of any WaveMaker application can be configured to deploy onto a CDN. This improves the end-user experience of the WaveMaker application because of dramatic gains made in the page load times.

## Introduction
 In this document, you will learn how to setup the deployment of WaveMaker frontend artifacts to CDN. While the instructions here deal with AWS, similar steps can be followed to deploy onto CDNs provided by any other cloud infrastructure providers.
...
[![static website enable](../assets/images/s3-static-website-enable.png)](../assets/images/s3-static-website-enable.png)
...
[![CDN origin settings](../assets/images/cdn-origin-setting.png)](../assets/images/cdn-origin-setting.png)

- Provide Cache behavior configuration details
[![CDN cache behaviour](../assets/images/cdn-cache-behaviour-settings.png)](../assets/images/cdn-cache-behaviour-settings.png)
...
[![CDN distribution settings](../assets/images/cdn-distribution-setting.png)](../assets/images/cdn-distribution-setting.png)
...
```
- For instructions on configuring the CDN URL in your application see [Configuring CDN URL](../../build-and-deploy/build/web/static-content.md)
