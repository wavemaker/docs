...
WaveMaker allows you to deploy your app to your DigitalOcean account for Live phase and Stage phase for WME users. For more information about app phases, see [Release Management](../release-management/).

To deploy your app to the DigitalOcean account, you should configure the Live phase, or Stage phase for WME.

:::note
This document covers the Live Phase configuration for your DigitalOcean account and is a part of the [Manage Deployed Apps](../manage-deployed-apps/)
:::
...
3. While configuring the Live phase choose to host your app on the DigitalOcean cloud provider.
    ...
    [![](./assets/img/manage_apps_live.png)](./assets/img/manage_apps_live.png)
...
![](./assets/img/deploy_do_setup.png)
...
![](./assets/img/deploy_do_new_cluster.png)
...
![](./assets/img/deploy_do_existing_cluster.png)
...
![](./assets/img/deploy_do_registry_details.png)
...
[![](./assets/img/deploy_do_app_configuration.png)](./assets/img/deploy_do_app_configuration.png)
...
![](./assets/img/deploy_do_configure_new_cluster.png)

![](./assets/img/deploy_do_configuring.png)

![](./assets/img/deploy_do_jobs_cluster_configuration.png)

On clicking the **Configure** button, for **existing cluster**, the Live phase is associated with already chosen cluster details.

![](./assets/img/deploy_do_configure_existing_cluster.png)
...
![](./assets/img/deploy_do_cluster_configured.png)

Once you click the **Push** button, you observe a [config profile window](../configuration-profiles). Configure the details as per your requirement and click **Next** and then **Push**.

![](./assets/img/deploy_do_push_to_live.png)

![](./assets/img/deploy_do_deploying.png)

The deployment progress can be tracked in the Jobs section of the respective project as shown below.

![](./assets/img/deploy_do_jobs_deployment.png)

After successful deployment, you can see options to view the deployment details, or go to the deployed URL.

![](./assets/img/deploy_do_deployment.png)
...
![](./assets/img/deploy_do_providerinfo1.png)

![](./assets/img/deploy_do_providerinfo2.png)
