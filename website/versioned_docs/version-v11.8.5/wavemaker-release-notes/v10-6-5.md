...
- Fixed an issue related to the Number widget to enable the Allow Trailing Zeros property in the Form and Live form widgets.
- Allow the Clear icon when a default value is present in the Search widget.
