...
1. The following sample report jrxml is provided for your reference which loads the data from hrdb **Employee** table and generates the report.
   ...
   <field name="EMP_ID" className="java.lang.Integer">
        <fieldDescription><![CDATA[EMP_ID]]></fieldDescription>
   </field>
   <field name="firstname" className="java.lang.String">
      <fieldDescription><![CDATA[firstname]]></fieldDescription>
   </field>
   <field name="lastname" className="java.lang.String">
        <fieldDescription><![CDATA[lastname]]></fieldDescription>
   </field>
   <field name="USERNAME" className="java.lang.String">
        <fieldDescription><![CDATA[USERNAME]]></fieldDescription>
   </field>
   <field name="ROLE" className="java.lang.String">
        <fieldDescription><![CDATA[ROLE]]></fieldDescription>
   </field>
   <field name="city" className="java.lang.String">
   ...
   <detail>
        <band height="20">
            <textField hyperlinkType="None">
                ...
                <textFieldExpression className="java.lang.Integer"><![CDATA[$F{EMP_ID}]]>
                </textFieldExpression>
            </textField>
            <textField hyperlinkType="None">
                ...
                <textFieldExpression className="java.lang.String"><![CDATA[$F{firstname}]]>
                </textFieldExpression>
            </textField>
            <textField hyperlinkType="None">
                ...
                <textFieldExpression className="java.lang.String"><![CDATA[$F{lastname}]]>
                </textFieldExpression>
            </textField>
            <textField hyperlinkType="None">
                ...
                <textFieldExpression className="java.lang.String"><![CDATA[$F{USERNAME}]]>
                </textFieldExpression>
            </textField>
            <textField hyperlinkType="None">
                ...
                <textFieldExpression className="java.lang.String"><![CDATA[$F{ROLE}]]>
                </textFieldExpression>
            </textField>
            <textField hyperlinkType="None">
                ...
                <textFieldExpression className="java.lang.String"><![CDATA[$F{city}]]>
                </textFieldExpression>
            </textField>
        </band>
   </detail>
...
1. Place the _.jrxml_ file in the java service src folder as shown below:
   [![](/learn/assets/Jasper_jrxml_location.png)](/learn/assets/Jasper_jrxml_location.png)

1. [Import Sample HRDB](/learn/app-development/services/database-services/working-with-databases/) database into the project
1. Autowire the imported DataBase dataSource bean in to the created java serice
...
1. Java service code to generate Jasper Report PDF from hrdb Employee table
   ...
   ```xml
     ...
     <jasperReport xmlns="http://jasperreports.sourceforge.net/jasperreports" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports http://jasperreports.sourceforge.net/xsd/jasperreport.xsd" name="Report" pageWidth="595" pageHeight="842" columnWidth="555" leftMargin="20" rightMargin="20" topMargin="20" bottomMargin="20" uuid="81afe112-ee1b-4443-8d1c-cb6d9ab95dd8">
         ...
         <subDataset name="results" uuid="4563e834-a9e5-43b5-9f0a-824948c73c73">
             <field name="Email" className="java.lang.String">
                 <fieldDescription><![CDATA[email]]></fieldDescription>
             </field>
             <field name="Gender" className="java.lang.String">
                 <fieldDescription><![CDATA[gender]]></fieldDescription>
             </field>
             <field name="Phone" className="java.lang.String">
