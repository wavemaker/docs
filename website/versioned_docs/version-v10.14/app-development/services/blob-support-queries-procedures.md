...
- [Use Cases for BLOB](#usecasesforblob)
- [Limitations](#limitations)
  - [Support for uploading the BLOB data as a query parameter](#supportforuploadingthe-blob-dataasaqueryparameter)
  - [Handling Blob content in query results (single or paginated results)](#handling-blobcontentinqueryresultssingleorpaginatedresults)
  - [Support for uploading the blob data as Procedure Param](#supportforuploadingtheblobdataasprocedureparam)
  - [Handling Blob content as output param of a procedure](#handling-blobcontentasoutputparamofaprocedure)
