...
class Index extends React.Component {
    getCategories() {
        ...
        let categories = [
            { href: '/learn/app-development/widgets/widget-library', backgroundImage: 'linear-gradient(to left, rgba(131, 195, 250, 0.51), #4c90f2)', icon: '/learn/img/exploreWidgets.svg', label: 'Comprehensive How-to\'s' },
