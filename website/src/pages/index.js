                ...
                <main className="main-container">
                    <div className=' banner footer-left'>
                        ...
                        {this.state.displayInfoFooter && <div className='banner-footer'>
                            <span className='banner-footer-msg'><img src='/learn/img/speaker.svg' />WaveMaker released an update v11.11.4. See what's new.</span>
                            <a className='banner-footer-action' href='/learn/wavemaker-release-notes/v11-11-4'>Read more</a>
