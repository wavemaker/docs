                ...
                <main className="main-container">
                    <div className='container banner spl-icon footer-left'>
                        ...
                        {this.state.displayInfoFooter && <div className='banner-footer'>
                            <span className='banner-footer-msg'><img src='/learn/img/speaker.svg' />WaveMaker released new features and updates in WM11.4.0. See what's new.</span>
                            <a className='banner-footer-action' href='/learn/wavemaker-release-notes/v11-4-0'>Read more</a>
