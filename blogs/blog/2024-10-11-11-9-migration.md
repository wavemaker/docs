...
---
---
As highlighted in one of our previous [posts](/blog/2024/10/01/spring6-upgrade), starting with version 11.9, WaveMaker applications will be transitioning to [Java 17/21](/blog/2024/08/29/java-17-and-21-upgrade) and Spring 6. This is a significant upgrade, and as noted earlier, regarding the shift from [javax to jakarta namespaces](/blog/2024/09/24/javax-to-jakarta), there is a namespace change in the dependent libraries that necessitates the migration of your WaveMaker applications.
