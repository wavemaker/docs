...
![SAP HANA Design](/img/blogs/sap-design-page.png)
...
![SAP HANA Configure List](/img/blogs/sap-configure-list.png)

After configuring the widget, you can preview the application and view the table data as a list.

![SAP HANA List Widget](/img/blogs/sap-list-widget.png)
...
![SAP HANA Table Options](/img/blogs/sap-table-options.png)

### Already have a SAP HANA Database?

Import the SAP HANA database by following the how-to’s doc [Connect To SAP HANA Database](#).
