...
![Detailed Bug Fix](/img/blogs/release-notes-blog/bug-fix-detailed.png)

Now, we can not only find the major library upgrade details but also the minor library upgrade details.

![Minor Backend Libraries](/img/blogs/release-notes-blog/backend-framework-new-libraries.png)
...
![Backdrop Before and After Fix](/img/blogs/release-notes-blog/backdrop-before-after-fix.png)

Wherever applicable, we have also emphasized the Impact of an enhancement or a bug.

![Enhancement Impact](/img/blogs/release-notes-blog/enhancement-impact.png)
...
![Collapsible View of Bug Fixes](/img/blogs/release-notes-blog/collapsible-view-bug-fixes.png)
