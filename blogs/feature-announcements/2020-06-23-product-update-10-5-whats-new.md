...
![custom formatter](/img/blogs/custom-formatter.png)

To learn about the usage of this feature, see [Using Custom Formatter for masking sensitive data](#).
...
![summary row function](/img/blogs/datatable_summaryrow4.png)

To learn more about how it works, check out the [Data Table summary row documentation](/docs/user-interfaces/web/components/angular-components/datalive/datatable/summary-row).

## Smart Widget Templates

***Just pick, click and apply away!***

For [Cards](/docs/user-interfaces/web/components/angular-components/datalive/cards), [List](/docs/user-interfaces/web/components/angular-components/datalive/list), and [Wizard](/docs/user-interfaces/web/components/angular-components/container/wizard) widgets, you can now quickly choose alternative UI representations while you can visually see the changes as you click on the template - just how the SmartArt works in PowerPoint. 

![widget template](/img/blogs/widget-template.gif)

For more information about applying a template as well as a layout from the canvas, see [Using Smart Template and Layout for Widgets](#).
...
Some of the critical bugs have been fixed in the release. See the list of [bug fixes here](#).
