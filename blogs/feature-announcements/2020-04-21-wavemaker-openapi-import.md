...
![OpenApi](/img/blogs/OpenAPI_Logo.png)
...
:::note
As of release 10.4, WaveMaker supports OAS 2.0. Support for OAS 3.0 is being worked upon. We made the OpenAPI support [more robust in 10.5](/feature-announcements/2020/07/01/wavemaker-openapi-postgrest-support). Keep an eye on this space for more updates.
:::
...
![Open API Import Use Case](/img/blogs/OpenAPI_Scenario.png)
