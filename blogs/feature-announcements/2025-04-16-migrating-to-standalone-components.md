...
![Module Based vs Standalone Components](/img/blogs/module-based-vs-standalone-components.png)
...
![](/img/blogs/bundle-size-before.png)

**After Moving to Standalone Components**
![](/img/blogs/bundle-size-after.png)
