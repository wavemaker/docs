...
![Horizontal Scaling Deployment Architecture](/img/blogs/horizontal-scaling.png)
...
![Distributed Persistence of User Authentication Session](/img/blogs/session-persistence.png)
