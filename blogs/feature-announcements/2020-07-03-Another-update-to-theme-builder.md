...
Here is another update on the [Theme builder](https://apps.wavemakeronline.com/Theme_Builder/#/Dashboard) app. After the [first release](/feature-announcements/2020/06/01/build-themes-without-any-coding) of theme builder, we thought of adding few more features and enhancements to enable our users to create great themes to get their web, mobile applications looking well finished.  
...
![theme builder font list](/img/blogs/theme-builder-font-list.png)
...
![theme builder dashboard](/img/blogs/theme-builder-dashboard-page.png),  ![theme builder leftnav](/img/blogs/theme-builder-left-navigation.png)
...
![theme builder headings](/img/blogs/theme-builder-headings.png)


* Modified the user profile menu

![theme builder popover menu](/img/blogs/theme-builder-popover-menu.png)
...
![theme builder buttons and dropdowns](/img/blogs/theme-builder-buttons.png)
![theme builder nav list](/img/blogs/theme-builder-navlist.png)
![theme builder panels](/img/blogs/theme-builder-panels.png)
![theme builder accordions ](/img/blogs/theme-builder-accordions.png)
![theme builder topnav and subheadings](/img/blogs/theme-builder-topnav.png)
...
![theme preview](/img/blogs/theme-builder-feedback.png)
