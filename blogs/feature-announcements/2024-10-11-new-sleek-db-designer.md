...
[![Designer after import](/img/blogs/dbdesigner/db-designer.png)](/img/blogs/dbdesigner/db-designer.png)

The developer has to choose the table from the left panel to view the table details.

[![Table View in Designer](/img/blogs/dbdesigner/table-view.png)](/img/blogs/dbdesigner/table-view.png)
...
[![Table With Relations](/img/blogs/dbdesigner/table-relations.png)](/img/blogs/dbdesigner/table-relations.png)
...
[![Old Designer](/img/blogs/dbdesigner/old-designer.png)](/img/blogs/dbdesigner/old-designer.png)
